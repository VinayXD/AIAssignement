...
public class BasicMCTSParams extends PlayerParameters {
    ...
    public BasicMCTSParams(long seed) {
        super(seed);
        addTunableParameter("K", Math.sqrt(2), Arrays.asList(0.0, 0.1, 1.0, Math.sqrt(2), 3.0, 10.0,20.0));
        addTunableParameter("rolloutLength", 10, Arrays.asList(0, 3, 10, 50, 100,200));
        addTunableParameter("maxTreeDepth", 100, Arrays.asList(1, 3, 10, 30, 100,200));
